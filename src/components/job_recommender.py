...
# Load dataset:
jd_df=pd.read_csv(r'D:\Job-Recommendation-System-main\Job-Recommendation-System-main\src\data\jd_structured_data.csv')

# Load the extracted resume skills:
file_path=r'D:\Job-Recommendation-System-main\Job-Recommendation-System-main\src\notebook\CV.pdf'
skills=[]
